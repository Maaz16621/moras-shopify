...
/>
        ...
        <AddToCartButton   className="px-6 py-2 bg-white text-black  border-black rounded-lg transition-all duration-300 transform hover:bg-black hover:text-white hover:scale-105"
