...
/>
        ...
        <AddToCartButton   className="px-6 py-4 bg-white text-black  border-black rounded-[15px] transition-all duration-300 transform hover:bg-black hover:text-white hover:scale-105"
